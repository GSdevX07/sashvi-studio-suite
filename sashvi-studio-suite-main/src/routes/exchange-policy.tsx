    ...
    <Layout>
      <section className="container-luxe pt-16 pb-24">
        ...
        <div className="prose prose-invert mt-8 max-w-none text-sm leading-relaxed text-muted-foreground">
          <p>
            At Sashvi Studio, we take utmost care in ensuring that every order reaches you in
            perfect condition.
          </p>
          <h2>No Returns</h2>
          <p>
            We do not accept returns or offer refunds on any products once they have been delivered.
          </p>
          <h2>Exchange Eligibility</h2>
          <ul>
            <li>
              We offer exchange only in cases where the product received is damaged during transit
              or a wrong product has been delivered.
            </li>
            <li>Exchange requests must be raised within 7 days from the date of delivery.</li>
            <li>
              The product must be unused, unworn, unwashed, and returned with its original tags,
              packaging, and accessories.
            </li>
          </ul>
          <h2>Important</h2>
          <p>
            A clear, continuous, and uncut unboxing video recorded from the moment the sealed
            package is opened is MANDATORY for any damage or exchange claim.
          </p>
          <p>
            Claims submitted without a complete uncut unboxing video will not be eligible for
            exchange.
          </p>
          <h2>Exchange Approval</h2>
          <p>
            Once the claim is verified by our team, we will arrange an exchange for the same product
            or an equivalent product, subject to stock availability.
          </p>
          ...
          <ul>
            ...
            <li>
              Incorrect size selection by the customer (unless there is a manufacturing defect).
            </li>
